package com.fansipan.habit.tracker.mood.screen.setting.content
...
import com.fansipan.habit.tracker.mood.databinding.ActivitySettingBeanBinding
import com.fansipan.habit.tracker.mood.screen.addbean.AddBeanActivity
import com.fansipan.habit.tracker.mood.screen.setting.content.adapter.BlockIconSettingAdapter
import com.fansipan.habit.tracker.mood.screen.setting.content.adapter.SettingBlockAdapter
import com.fansipan.habit.tracker.mood.screen.setting.content.dialog.DialogAddNewBlock
import com.fansipan.habit.tracker.mood.screen.setting.content.dialog.DialogAddNewIcon
import com.fansipan.habit.tracker.mood.screen.setting.content.dialog.DialogChangeInfoIcon
import com.fansipan.habit.tracker.mood.screen.setting.content.dialog.DialogConfirmExit
import com.fansipan.habit.tracker.mood.screen.setting.content.dialog.DialogConfirmRemoveIcon
import com.fansipan.habit.tracker.mood.screen.setting.content.dialog.DialogMoveBlock
import com.fansipan.habit.tracker.mood.screen.setting.content.entity.BlockIconDetailEntity
...
//            if (isEdit) {// show inter
//                if (RemoteConfigUtil.isShowInter && !SharePrefUtils.isBought()) {
//                    MaxUtilsV2.getInstance(this).setMaxUtilsListener {
//                        saveDataAndBack()
//                    }
//                    MaxUtilsV2.getInstance(this).showInterstitialAd()
//                }
//
//            } else {
//                saveDataAndBack()
