...
import com.fansipan.habit.tracker.mood.databinding.ActivityMainBinding
...
import com.fansipan.habit.tracker.mood.utils.showDialogRating
...
class MainActivity : BaseActivity<ActivityMainBinding>() {
    ...
    override fun initView() {
        ...
        Constant.isPremium.observe(this) {
            //initBanner(binding.banner, it)
        }
