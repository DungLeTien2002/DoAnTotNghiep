...
import com.fansipan.habit.tracker.mood.databinding.ActivityAddBeanBinding
import com.fansipan.habit.tracker.mood.screen.premium.PremiumActivity
import com.fansipan.habit.tracker.mood.screen.setting.content.SettingBeanActivity
...
import com.fansipan.habit.tracker.mood.utils.clear
import com.fansipan.habit.tracker.mood.utils.getActivityResultLauncher
import com.fansipan.habit.tracker.mood.utils.getDataSerializable
import com.fansipan.habit.tracker.mood.utils.gone
import com.fansipan.habit.tracker.mood.utils.hideKeyboard
import com.fansipan.habit.tracker.mood.utils.isSoftKeyboardVisible
...
import com.fansipan.habit.tracker.mood.utils.scrollToBottom
...
//        blockIconAdapter.setDataList(dataList)
    ...
    override fun initListener() {
        binding.edtTodayNote.setOnFocusChangeListener { _, isFocus ->
            if (isFocus) {
                binding.nestedScrollView.scrollToBottom()
            }
        }
