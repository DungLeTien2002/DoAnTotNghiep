...
import com.fansipan.habit.tracker.mood.BeanDailyApplication
import com.fansipan.habit.tracker.mood.BuildConfig
import com.fansipan.habit.tracker.mood.R
import com.fansipan.habit.tracker.mood.data.database.BeanViewModelFactory
import com.fansipan.habit.tracker.mood.screen.setting.app.Question

object Constant {
    const val BEAN_CALENDAR = "BEAN_CALENDAR"
    const val TAG = "dunglt"
    ...
    const val IS_QUESTION="is_question"
    const val QUESTION="question"
    const val ANSWER="answer"
    val  questions = listOf(
        Question(1, "Which season do you prefer?", listOf("Spring", "Summer", "Autumn")),
        Question(2, "What type of music do you enjoy the most?", listOf("Pop", "Rock", "Hip-hop")),
        Question(3, "Which country is your favorite?", listOf("Italian", "VietNam", "Indian")),
        Question(
            4,
            "What is your preferred mode of transportation?",
            listOf("Car", "Bicycle", "Public transport")
        ),
        Question(5, "Which movie genre do you prefer?", listOf("Action", "Comedy", "Drama")),
        Question(
            6,
            "What is your favorite outdoor activity?",
            listOf("Hiking", "Swimming", "Cycling")
        ),
        Question(
            7,
            "Which social media platform do you use the most?",
            listOf("Facebook", "Instagram", "TikTok")
        ),
        Question(
            8,
            "What is your favorite type of book?",
            listOf("Fiction", "Mystery/Thriller", "Romance")
        ),
        Question(
            9,
            "Which type of vacation do you prefer?",
            listOf("Beach", "Mountains", "Countryside")
        ),
        Question(10, "What is your favorite dessert?", listOf("Ice cream", "Cake", "Cookies")),
    )
    ...
    //---------------------------- native ad ----------------------------
//    const val NATIVE_AD_LOAD1 = BuildConfig.ADS_NATIVE_ID1
//    const val NATIVE_AD_LOAD2 = BuildConfig.ADS_NATIVE_ID2
//    const val NATIVE_AD_TEST = BuildConfig.ADS_NATIVE_TEST
//
//    var mapNativeAd = mutableMapOf<Int, NativeAd?>()
    //-------------------------------------------------------------------
