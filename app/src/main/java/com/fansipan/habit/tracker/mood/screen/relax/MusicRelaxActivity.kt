...
import com.fansipan.habit.tracker.mood.data.entity.MusicCalmEntity
import com.fansipan.habit.tracker.mood.databinding.ActivityMusicRelaxBinding
import com.fansipan.habit.tracker.mood.screen.home.calendar.TAG
...
class MusicRelaxActivity : BaseActivity<ActivityMusicRelaxBinding>() {
    ...
    private var countChangeView = object : CountDownTimer(60000 * 1000, 10 * 1000) {
        override fun onTick(millisUntilFinished: Long) {
            if (!SharePrefUtils.isBought() && RemoteConfigUtil.isShowNative) {
//                slideChangeDiscNativeAds()
            }
        }
