...
import com.fansipan.habit.tracker.mood.screen.addbean.BeanTypeEntity
import com.fansipan.habit.tracker.mood.screen.relax.AmbientSound
import com.fansipan.habit.tracker.mood.screen.relax.SoundEntity
import com.fansipan.habit.tracker.mood.screen.relax.TriggerSound
import com.fansipan.habit.tracker.mood.screen.report.ChartEntry
...
import com.fansipan.habit.tracker.mood.screen.timeline.BeanIconDetailEntity
...
object DataUtils {
    ...
    fun getBaseBeanType(context: Context) = mutableListOf(
        ...
        IconBase(
            context.getString(R.string.status_4), R.drawable.ic_bean_type_4_off, R.drawable
